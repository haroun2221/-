        ...
        <div className="flex items-center gap-4">
            ...
            <div className="relative">
                <button onClick={toggleMenu} className="flex items-center gap-2">
                    <img src={`https://placehold.co/40x40/2E3D80/ffffff?text=${user.email.charAt(0).toUpperCase()}`} alt="User Avatar" className="w-10 h-10 rounded-full border-2 border-[var(--primary)]" />
                </button>
                {isMenuOpen && (
                ...
                <div className="flex justify-between items-center h-20">
                    ...
                    <div className="flex-shrink-0">
                        <a href="#" onClick={(e) => { e.preventDefault(); onNavigate('home'); }}>
                           <img className="h-12 w-auto" src="https://i.ibb.co/9gq85f4/photo-2025-09-17-12-03-57.jpg" alt="SaaHla Logo" />
                        </a>
                    </div>
            ...
            {isMobileMenuOpen && (
                <div className="md:hidden bg-white border-t p-4 space-y-2 animate-[fadeIn_0.3s_ease-out]">
                    ...
                    <div className="border-t pt-4 space-y-2">
                         {currentUser ? (
                            <>
                                <div className="px-4 py-2 font-semibold">{currentUser.email}</div>
